...
export \
  ...
  PATH=$CURL_BIN_DIR:$PIPX_BIN_DIR:$RUST_CARGO_BIN_DIR:$GNU_AWK_BIN_DIR:$GNU_COREUTILS_BIN_DIR:$GNU_FINDUTILS_BIN_DIR:$GNU_GREP_BIN_DIR:$GNU_SED_BIN_DIR:$GNU_TAR_BIN_DIR:$PATH \
